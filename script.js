...
function updateSquarePerimeterResult() {
    ...
    document.getElementById('keliling-result').textContent = kelilingPersegiResult;
}

document.getElementById('luas-calculate-button').addEventListener('click', updateSquareAreaResult);
document.getElementById('keliling-calculate-button').addEventListener('click', updateSquarePerimeterResult);
...
document.getElementById('restart-button').addEventListener('click', restartCalculator);
